...
his project demonstrates how to use Terraform to build an Amazon Route53 Private Hosted Zone (PHZ) and share across VPCs in the same AWS Region and AWS account.
...
2. Destroy all Terraform resources:
   ...
   ```bash
   [ec2-user@ip-10-10-10-146 ~]$ terraform destroy --auto-approve
   ```
...
| [app_sg](https://github.com/terraform-aws-modules/terraform-aws-security-group) | terraform-aws-modules/security-group/aws | n/a |
| [alb_sg](https://github.com/terraform-aws-modules/terraform-aws-security-group) | terraform-aws-modules/security-group/aws | n/a |
...
| Name | Description |
|------|-------------|
| alb_alias_fqdn | The FQDN of the ALB alias record |
| alb_dns_name | The DNS name of the internal ALB |
| client_instance_private_ip | Private IP of the client instance |
| connect_to_client_instance | Command to connect to the client instance using EC2 Instance Connect |
